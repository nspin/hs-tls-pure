...
processHandshake :: MonadThrow m => Context m -> Handshake -> m ()
...
processClientKeyXchg :: MonadThrow m => Context m -> ClientKeyXchgAlgorithmData -> m ()
...
processClientFinished :: MonadThrow m => Context m -> FinishedData -> m ()
